...
function openPostDetail(postId) {
    ...
    // --- 修复收藏红心消失的 Bug 开始 ---
        ...
        // HTML 里的 data-is-favorited，在 JS 的 dataset 里会自动变成驼峰命名 isFavorited
        if (card.dataset.isFavorited === 'true') {
            favoriteBtn.innerHTML = '❤️ 已收藏';
            favoriteBtn.classList.add('active'); // 确保这里的 active 是你们 CSS 里红心亮起的样式名
        } else {
